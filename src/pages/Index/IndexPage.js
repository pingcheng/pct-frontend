    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center mx-auto" style={{
            ...
            <div className="font-code text-gray-400">
                <h1 className="mb-8 text-base">Hi! It is <span className="text-black">{ profile.name }</span> here.</h1>
                ...
                <p className="mb-8">Focusing on <span className="text-black">Node/TS/JS, Java, PHP, Linux, Server management</span>, etc...</p>
            </div>

            {/* Social links */}
            <div className="flex flex-wrap content-around text-lg justify-center">
                <a className="social-link mr-4 p-2" href={ urls.githubUrl }><FiGithub /> Github</a>
