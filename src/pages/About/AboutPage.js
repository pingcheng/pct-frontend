                ...
                <SimpleRowData label="skills">
                    <div className="mb-2">
                        ...
                        <div className="text-gray-400 text-xs">
                            { backendStack.map(text => <div key={text}>{ text }</div>) }
                        </div>
                    </div>
                    ...
                    <div className="mb-2">
                        ...
                        <div className="text-gray-400 text-xs">
                            { frontendStack.map(text => <div key={text}>{ text }</div>) }
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="text-gray-400 text-xs">
                            { devOpsStack.map(text => <div key={text}>{ text }</div>) }
                        </div>
                    </div>
                </SimpleRowData>
        ...
        return (
            <div className="mb-2" key={index}>
                ...
                <div className="text-gray-400 text-xs">
                    ...
                    {experience.description.map(text => <p key={text}>{text}</p>)}
                </div>
            </div>
        );
    });
